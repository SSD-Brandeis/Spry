...
# run('20', RD_list=[100], sel_list=[0.001])
# run('21', RD_list=[100], sel_list=[0.001])
# run('22', RD_list=[100], sel_list=[0.001])
# run('23', RD_list=[100], sel_list=[0.001])
run('24', RD_list=[100], sel_list=[0.001])
run('25', RD_list=[100], sel_list=[0.001])
run('26', RD_list=[100], sel_list=[0.001])
run('27', RD_list=[100], sel_list=[0.001])
