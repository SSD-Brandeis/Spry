...
def gen_insertion_workload(
    ...
    task = "./K-V-Workload-Generator-master/load_gen" + f" --insert={insert} --range_delete={rd} --range_delete_selectivity={sel} --entry_size={E} --range_delete_threshold={rd_threshold} --key_size={key_size}"
    print(task)
    os.system(task)
...
rdf_types = [
    ...
    {"--using_rdf_types": ["SuRF_LF_RDF"], "--surf__key_len_in_bytes": [4], "--use_surf_base": [1], "--skip_reading_RD_blocks":[0], "--surf_use_condensed_digit_key":[0]},
    {"--using_rdf_types": ["SuRF_LF_SPLIT_RDF"], "--surf__key_len_in_bytes": [4], "--use_surf_base": [1], "--skip_reading_RD_blocks":[0], "--surf_use_condensed_digit_key":[0]},
    {"--using_rdf_types": ["SuRF_LF_RDF"], "--surf__key_len_in_bytes": [8], "--use_surf_base": [1], "--skip_reading_RD_blocks":[0], "--surf_use_condensed_digit_key":[0]},
    {"--using_rdf_types": ["SuRF_LF_SPLIT_RDF"], "--surf__key_len_in_bytes": [8], "--use_surf_base": [1], "--skip_reading_RD_blocks":[0], "--surf_use_condensed_digit_key":[0]},
    ...
    {"--using_rdf_types": ["SuRF_LF_RDF"], "--surf__key_len_in_bytes": [12], "--use_surf_base": [1], "--skip_reading_RD_blocks":[0], "--surf_use_condensed_digit_key":[0]},
    {"--using_rdf_types": ["SuRF_LF_SPLIT_RDF"], "--surf__key_len_in_bytes": [12], "--use_surf_base": [1], "--skip_reading_RD_blocks":[0], "--surf_use_condensed_digit_key":[0]},
    ...
    {"--using_rdf_types": ["SuRF_LF_RDF"], "--surf__key_len_in_bytes": [15], "--use_surf_base": [1], "--skip_reading_RD_blocks":[0], "--surf_use_condensed_digit_key":[0]},
    {"--using_rdf_types": ["SuRF_LF_SPLIT_RDF"], "--surf__key_len_in_bytes": [15], "--use_surf_base": [1], "--skip_reading_RD_blocks":[0], "--surf_use_condensed_digit_key":[0]},
