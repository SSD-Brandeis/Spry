...
rd_list = [100, 100, 100, 100, 100, 100, 100]
sel_list = [0.00001, 0.0001, 0.001, 0.0005, 0.00025, 0.000125, 0.0000625]
...
workload_filename_list = [
   ...
   f"workload/workload7116.txt",
   f"workload/workload7117.txt",
]
