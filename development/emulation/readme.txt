...
#./emu_runner -i 10 -P 4 -B 2 -E 32 -T 2 -h 1 -V 1
#./emu_runner -i 10 --RD 10 -P 4 -B 2 -E 32 -T 2 -h 1 -V 1
#./emu_runner -i 100000 --RD 10 -P 4 -B 2 -E 32 -T 2 -h 1 -V 0 --selectivity 0.001 --workload_filename "workload1.txt"
./emu_runner -i 100000 --RD 10 -P 4 -B 2 -E 32 -T 2 -h 1 -V 0 --selectivity 0.001 --workload_filename "workload1.txt" --insert_before_range_delete 0.9
